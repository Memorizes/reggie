...
-- Records of category
-- ----------------------------
INSERT INTO `category` VALUES (1397844263642378242, 1, '湘菜', 1, '2021-05-27 09:16:58', '2022-12-30 18:30:59', 1, 1);
...
-- Records of dish
-- ----------------------------
INSERT INTO `dish` VALUES (1397849739276890114, '辣子鸡', 1397844263642378242, 7800.00, '222222222', 'f966a38e-0780-40be-bb52-5699d13cb3d9.jpg', '来自鲜嫩美味的小鸡，值得一尝', 0, 0, '2021-05-27 09:38:43', '2022-12-31 19:15:41', 1, 1, 0);
INSERT INTO `dish` VALUES (1397850140982161409, '毛氏红烧肉', 1397844263642378242, 6800.00, '123412341234', '0a3b3288-3446-4420-bbff-f263d0c02d8e.jpg', '毛氏红烧肉毛氏红烧肉，确定不来一份？', 0, 0, '2022-12-31 18:05:54', '2022-12-31 18:05:54', 1, 1, 0);
...
INSERT INTO `dish_flavor` VALUES (1397850141015715841, 1397850140982161409, '忌口', '[\"不要葱\",\"不要蒜\",\"不要香菜\",\"不要辣\"]', '2022-12-31 18:05:54', '2022-12-31 18:05:54', 1, 1, 0);
INSERT INTO `dish_flavor` VALUES (1397850141040881665, 1397850140982161409, '辣度', '[\"不辣\",\"微辣\",\"中辣\",\"重辣\"]', '2022-12-31 18:05:54', '2022-12-31 18:05:54', 1, 1, 0);
...
-- Records of employee
-- ----------------------------
INSERT INTO `employee` VALUES (1, '管理员', 'admin', 'e10adc3949ba59abbe56e057f20f883e', '18012345678', '1', '110101199001010047', 1, '2021-05-06 17:20:07', '2022-12-30 15:03:02', 1, 1);
INSERT INTO `employee` VALUES (2, '管理员', 'admin2', 'e10adc3949ba59abbe56e057f20f883e', '18012345678', '1', '123456789123456789', 1, '2022-12-30 15:47:48', '2022-12-30 15:52:39', 1, 1);
INSERT INTO `employee` VALUES (1607624139147857922, '张三', 'zhangsan', 'e10adc3949ba59abbe56e057f20f883e', '18012345678', '1', '111222333444555666', 1, '2022-12-27 14:27:18', '2022-12-30 17:49:38', 1, 2);
INSERT INTO `employee` VALUES (1607666167244189698, '李四', 'lisi', 'e10adc3949ba59abbe56e057f20f883e', '18012345678', '1', '111222333444555666', 1, '2022-12-27 17:14:18', '2022-12-30 17:43:23', 1, 1);
...
-- ----------------------------
INSERT INTO `order_detail` VALUES (1612300437875097601, '组庵鱼翅', '740c79ce-af29-41b8-b78d-5f49c96e38c4.jpg', 1612300437812183042, 1397850392090947585, NULL, '微辣,中辣', 1, 48.00);
INSERT INTO `order_detail` VALUES (1612300437875097602, '北冰洋', 'c99e0aab-3cb7-4eaa-80fd-f47d4ffea694.png', 1612300437812183042, 1413342036832100354, NULL, '冷藏', 1, 5.00);
...
-- Records of setmeal
-- ----------------------------
INSERT INTO `setmeal` VALUES (1415580119015145474, 1413386191767674881, '儿童套餐A计划', 4000.00, 1, '', '', '61d20592-b37f-4d72-a864-07ad5bb8f3bb.jpg', '2021-07-15 15:52:55', '2022-12-31 19:15:46', 1415576781934608386, 1, 0);
...
CREATE TABLE `user`  (
  ...
  `email` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL COMMENT '手机号',
